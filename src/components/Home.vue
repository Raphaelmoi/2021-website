  ...
  <section class="homecont">
    <div
      ...
      @click="
        ...
        hideBkg();
      "
      v-if="itemMenu !== '' && $store.state.isMobile"
    >
      <i class="fas fa-bars"></i>
    </div>

    <div class="giantCircle" v-if="itemMenu === '' || !$store.state.isMobile">
      <div class="centerCircle">
        ...
        <div
          ...
          @click="itemMenu = 'cv'"
        >
          <a class="navItem item5" :class="itemMenu === 'cv' ? 'activeIM' : ''"
            >Mon CV</a
          >
        </div>
    ...
    <div class="linkContent standup" v-if="itemMenu == 'stand-up'">
      <div>
        ...
        <div class="imgBox">
          <img src="@/assets/home/G10.jpg" alt />
          <img src="@/assets/home/jump.jpg" alt />
          <img src="@/assets/home/sc.jpg" alt />
        </div>
        <p>
          Projet libre et dernier projet de ma formation de développeur web. Il
          s'agit d'un site proposant plusieurs petits jeux fonctionnant grâce à
          des outils de reconnaissance faciale. On peut ainsi jouer en
        ...
        <a href="https://raphaelmouly.com/projet5/index.php" class="btnHome"
          >Visiter le site</a
        >
      </div>
    </div>
    ...
    <div class="linkContent pagination" v-if="itemMenu == 'pagination'">
      <div>
        ...
        <p>
          ...
          <router-link to="/pagination" class="btnHome">Pagination</router-link>
        </p>
      </div>
    </div>
    ...
    <div class="linkContent labyrinthe" v-if="itemMenu == 'labyrinthe'">
      <div>
        ...
        <p>
          <span>Un algorithme dessinant un labyrinthe</span>
          <br />
          <span>Réalisé avec la librairie p5.js</span>
          <a
            href="/static/maze2/index.html"
            class="btnHome"
            style="color: rgb(186, 0, 13)"
            >Jouer ( dev en cours... )</a
          >
        </p>
      </div>
    </div>
    ...
    <div class="linkContent labo" v-if="itemMenu == 'cv'">
      <div>
        ...
        <p>
          ...
          <br />
          <br />
          <a href="/static/cvweb/index.html" class="btnHome"
            >curriculum vitae</a
          >
        </p>
      </div>
    ...
    <div class="linkContent" v-if="itemMenu == 'mousefire'">
      <div>
        ...
        <p>
          <br />
          <br />
          <a href="/static/mousep5/index.html" class="btnHome">Voir</a>
        </p>
      </div>
    </div>
  ...
  methods: {
    ...
    callMaze() {
      if (!document.getElementById("mazeA")) {
        ...
        script.src = "/static/maze/js/sketch.js";
        script.type = "text/javascript";
        script.id = "mazeA";
        var script2 = document.createElement("script");
        script2.src = "/static/maze/js/Cell.js";
